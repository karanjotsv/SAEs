...
def test_sae_training():
    ...
    save_steps = None
    # warmup period at start of training and after each resample
    warmup_steps = 1000 
    resample_steps = None
...
def test_evaluation():
    ...
    model = AutoModelForCausalLM.from_pretrained(MODEL_NAME, device_map="auto", dtype=t.float32).to(DEVICE)
